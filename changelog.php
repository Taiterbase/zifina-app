...
<?php  }  ?>
 ...
 <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-6 col-sm-12 col-xs-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Changelog # 1 Test  <div class="form-group pull-right">
                    <select id="changelog-select" class="form-control form-control-sm">
                            <option value="2020/04/19" selected="selected">Sunday, 19 April 2020</option>
                            <option value="2020/04/11">Saturday, 11 April 2020</option>
                    </select>
                </div>
				</div>
      ...
      <div class="panel-body">
                    ...
                    <span class="title">Saturday, 14 April 2020</span>
