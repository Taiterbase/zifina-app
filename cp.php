...
array($row2);
        if ($row2['race'] == 1 || $row2['race'] == 3 || $row2['race'] == 4 || $row2['race'] == 7 || $row2['race'] == 11){
                $side = '<div class="game-icon--rounded game-icon game-icon-xs game-icon--faction-0" data-toggle="tooltip" data-placement="top" title="Alliance"><div class="game-icon-icon"></div></div>';
...
?>
    ...
    <div class="col-md-12">
        <div class="infocard">
            <div class="card-header"><i class="fa fa-lock"></i> Security</div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 security-box mb-lg-0">
                        <div class="card-header"><i class="fa fa-mobile-phone"></i><i class="indicator disabled"></i></div>
                        <div class="card-body text-center">
                            <p class="card-text">Two-factor authentication</p>
                            <a class="card-link" href="/account/manage">Manage</a>
                        </div>
                    </div>
                    <div class="col-md-4 security-box mb-lg-0">
                        <div class="card-header"><i class="indicator igp disabled"></i><i class="wow-o-60"></i></div>
                        <div class="card-body text-center">
                            <p class="card-text">In-game protection</p>
                            <a class="card-link" href="/account/manage">Enable</a>
                        </div>
                    </div>
                    <div class="col-md-4 security-box mb-lg-0">
                        <div class="card-header"><i class="fa fa-lock"></i></div>
                        <div class="card-body text-center">
                            <a class="card-link" href="/account/manage">Change password</a>
                        </div>
                    </div>
                </div>
            </div>
