    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li><a href='/connect'><span class='glyphicon glyphicon-signal'></span> Connection Guide</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
				...
				<li class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle " data-toggle="dropdown"><?php echo htmlspecialchars($_SESSION["username"]); ?> <i class="fa fa-chevron-down"></i>
                    </a>
...
<div class="container">
	...
	<div class="panel panel-default">
         <div class="panel-heading"><span class="glyphicon glyphicon-info-sign"></span> Top 10 killers </div>
           <div class="panel-body">
<?php
$sql = "SELECT * FROM " . $dbChar . ".characters ORDER BY `totalKills` DESC LIMIT 10";
$result = $db->query($sql);
print '<div class="row">
        <div class="col-md-12">
...
array($row);
        if ($row['race'] == 1 || $row['race'] == 3 || $row['race'] == 4 || $row['race'] == 7 || $row['race'] == 11){
                $side = '<div class="game-icon--rounded game-icon game-icon-xs game-icon--faction-0" title="Alliance"><div class="game-icon-icon"></div></div>';
               
        }
        else{
                $side = '<div class="game-icon--rounded game-icon game-icon-xs game-icon--faction-1" title="Horde"><div class="game-icon-icon"></div></div>';
